...
mod tests {
    ...
    pub fn is_unsecurified_unhardened() {
        ...
        assert!(Sut::Unsecurified { is_hardened: false }.is_unsecurified_unhardened());
        assert!(!Sut::Unsecurified { is_hardened: true }.is_unsecurified_unhardened());
    }

    #[test]
    pub fn is_unsecurified_hardened() {
        assert!(!Sut::Securified.is_unsecurified_hardened());
        assert!(Sut::Unsecurified { is_hardened: true }.is_unsecurified_hardened());
        assert!(!Sut::Unsecurified { is_hardened: false }.is_unsecurified_hardened());
    }
}
